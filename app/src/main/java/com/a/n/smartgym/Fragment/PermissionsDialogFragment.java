...
public class PermissionsDialogFragment extends DialogFragment {
  ...
  private static final String TAG = PermissionsDialogFragment.class.getSimpleName();
  ...
  private void showAppSettingsDialog() {
    new AlertDialog.Builder(context)
        ...
        .setPositiveButton("SmartGymApplication Settings", new DialogInterface.OnClickListener() {
          @Override
